...
import { SEIBU, CHUBU, TOBU, SCALES, DEFAULT_SCALE, BASE_PATH } from '../lib/constants/tottori';
                          ...
                          <div className={`min-w-0 ${excluded.has(m.code) ? 'opacity-40' : ''}`}>
                            ...
                            {info && (
                              <div className="text-xs text-gray-600">
                                {mm(info.w)} × {mm(info.h)} mm・高さ {info.z.toFixed(1)} mm
                              </div>
                            )}
                          </div>
                        </div>
